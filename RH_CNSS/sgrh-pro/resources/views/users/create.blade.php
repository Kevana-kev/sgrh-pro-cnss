...
<div class="page-header">
    <div>
        ...
        <p class="page-header__meta">Créer un compte d'accès</p>
    </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group form-group--full">
                    <div class="form-check">
                        ...
                        <input type="checkbox" id="must_change_password" name="must_change_password" value="1" @checked(old('must_change_password', true))>
                        <label for="must_change_password">Forcer le changement de mot de passe à la prochaine connexion</label>
                    </div>
                </div>
            </div>
